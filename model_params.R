...
mean.prod = production.w * n.resources
mean.con = consumption.w * n.resources


rE_params <- list(n.species = n.species, n.resources = n.resources, 
                  mean.prod = mean.prod, mean.con = mean.con, maintenance = maintenance)

...
```{r}
# replicate the fig1a
EX5.1 <- glvExample5(n.species = 4, alpha = 0.3)
makePlot(EX5.1$GLV$matrix) + scale_y_log10(limits = c(1E-8, 1))
EX5.2 <- glvExample5(n.species = 20, alpha = 0.3)
makePlot(EX5.2$GLV$matrix) + scale_y_log10(limits = c(1E-8, 1))
EX5.3 <- glvExample5(n.species = 50, alpha = 0.3)
...
```{r}
# replicate the fig1b
EX5.4 <- glvExample5(n.species = 50, alpha = 0.08)
makePlot(EX5.4$GLV$matrix) + scale_y_log10(limits = c(1E-8, 1))
EX5.5 <- glvExample5(n.species = 50, alpha = 0.16)
makePlot(EX5.5$GLV$matrix) + scale_y_log10(limits = c(1E-8, 1))
EX5.6 <- glvExample5(n.species = 50, alpha = 0.64)

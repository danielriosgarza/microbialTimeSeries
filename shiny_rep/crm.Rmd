...
The function uses the Monod equation the feeding form
...
The function allows the user to choose different dynamics for the nutrient supply by controlling the volume, inflow, and outflow of nutrients, which allows the simulation conditions such as batch, fed-batch, and chemostat.
...
Communities are often operated with a non-continuous nutrient flux. An operation mode that is commonly used in ecological studies of synthetic microbial ecosystems is performing a series of passages of a communities to fresh media after a fixed time interval (e.g. [Goldford et al. 2018](https://www.science.org/doi/10.1126/science.aat1168)).
...
#simulate the model
CRMsimul <- simulateConsumerResource(n.species = 3, n.resources = 4, stochastic = 0, migration.p = 0.0, E=E,inflow.rate = .5, outflow.rate = .5,resources = resources, names.species = c('homoacetogenic', 'homofermentative', 'butyrateProducer'), names.resources = c('glucose', 'acetate', 'lactate', 'butyrate'), x0=x0, t.end = 10000, growth.rates = grs)
...
E = randomE(n.species = 10, n.resources = 7, mean.consumption = 3, mean.production = 1, maintenance = 0.5, trophic.preferences = list(c(25,15,10,1,1,1,1)), names.resources = c('glucose', 'lactose', 'arabinose', 'xylose', 'sorbitol', 'rhamnose', 'ribose') )

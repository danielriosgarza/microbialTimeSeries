...
In our program, $x0$ defines the populations of each species($N$), $growth_rates$ defines their corresponding growth rates ($r$). In addition to growth rates, we added death rates $death_rates$ to simulate the death of species.

$\frac{dN}{dt} = growth_rates \times N(1-\frac{N}{K}) - death_rates \times N$
